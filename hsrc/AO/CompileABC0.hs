...
-- Older design of compiler, initial pass.
-- (DEPRECATED, but a nice prototype.)
module AO.CompileABC0
...
--
-- TODO: consider adding ReaderT to limit depth 
--   of 'ap' and 'condap', but only if necessary to eliminate
--   loops in practice; so far this hasn't been an issue
data V0
